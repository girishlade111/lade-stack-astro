...
export const ko: LocaleContent = {
  ...
  privacy: [
    {
      h: '개요 및 개인정보 보호 원칙',
      p: 'Lade Stack은 기리시 라데(Girish Lade)가 인도에서 설립한 독립 개발자 도구 및 생성형 AI 엔지니어링 생태계입니다. 우리의 가장 근본적인 철학은 기본 설계에 의한 프라이버시 보호(Privacy by Design)입니다. 즉, 침해적인 텔레메트리, 사용자 감시, 불투명한 데이터 상업화 없이 소프트웨어 본연의 가치를 제공하는 것입니다. 우리는 수집하는 데이터를 기술적으로 가능한 최소한으로 제한하며, 파일 처리 및 주요 연산을 사용자의 브라우저 로컬 환경에서 실행하고, 귀하의 개인정보를 데이터 브로커나 광고 네트워크에 판매하거나 대여하지 않습니다.'
    },
    {
      h: '이용자가 직접 제공하는 정보',
