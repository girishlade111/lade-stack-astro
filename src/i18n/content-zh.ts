...
export const zh: LocaleContent = {
  ...
  privacy: [
    {
      h: '概述与隐私原则',
      p: 'Lade Stack 是由 Girish Lade 在印度创立的独立开发者工具与生成式 AI 工程生态。我们最核心的设计原则是“源头隐私”（Privacy by Design）：软件应当赋能用户，而非通过侵入式遥测、无端监控或隐蔽的数据变现来牟利。我们在技术可行范围内严格将数据收集降至最低，尽量将文件处理与计算保留在用户的本地浏览器中执行，绝不向数据经纪商或广告网络出售、出租您的个人信息。'
    },
    {
      h: '您主动提供的信息',
