...
export const en: LocaleContent = {
  ...
  studioWindow: {
    readyStatus: 'ready',
    viewer: {
      comment: '// @ladestack/engine — Autonomous Edge SSG & Code Intelligence',
      buildStatus: 'BUILD COMPLETE',
      buildDetails: '27 articles, 9 tools, 0kb client js runtime',
      readyText: 'Ready at',
      readySuffix: '(0ms TTFB)'
    },
    api: {
      resultText: '> 2/2 tests passed (42ms) • SSL Verified'
    },
    preview: {
      comment: '<!-- Generated by Website Builder AI • Semantic Astro Target -->',
      badge: 'SYSTEM READY',
      heading: 'Engineered for Extreme Speed',
      subtitle: 'Zero client-side JS runtime with 100% SSG.',
      button: 'Explore Suite',
